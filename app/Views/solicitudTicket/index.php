...
<a class="nav-link fw-bold py-1 px-0" href="#">Contact</a>
    ...
    <main class="px-3">
        ...
        <p class="lead">La fuente más habitual de los tickets son los usuarios finales de los sistemas y servicios de TI
            que solicitan la ayuda del equipo de soporte a través de algún tipo de portal de autoservicio, correo
